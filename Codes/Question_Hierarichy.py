...
def Ques_Hierarchy(Ques , Img , max_length=55 ):
    ...
    word_level = Embedding ( 1000 , 512 , input_length=max_length)(Ques)
    """
    ...
    """
    Question_level =  LSTM(512,input_shape=(15,512) ,return_sequences='true')(word_level)
    return word_level , Question_level
